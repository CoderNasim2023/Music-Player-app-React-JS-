...
const Navbar = ({ keyword, handleKeyPress, setKeyword, fetchMusicData }) => {
  ...
  const removePinnedMusic= musicContext.removePinnedMusic// Add this line
  const removeLikedMusic = musicContext.removeLikedMusic
  return (
    <>
      <nav className="navbar navbar-dark navbar-expand-lg bg-dark sticky-top">
        <div className="container-fluid">
          <Link className="navbar-brand ms-8 me-5 ps-3 fw-bold" to="/">
           OneMusic
          </Link>
          <div>
            <button
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <PinnedMusic onUnpin={removePinnedMusic} />
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <LikedMusic onUnpin={removeLikedMusic} />
            </div>
          </div>
        </div>
      </div>
